    ...
    if ($park_no == 10) {
		...
		if ($phase=="tag"){
			...
			if($subpark_id == 279){ // Inverter
				...
				$diagrammCode .='<tr><td>&nbsp;</td></tr>';
				$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=43&phase=INV1G4&defaults=0,1,2,3,4&args=0,1,0,8379,Inv_PR,Inv1(REFSU1)%20PR,15,%,4;0,1,0,8379,Inv_irrad_250,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,8379,AC_Module_Temp_250,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-4" border="0"></iframe></td></tr>';
				$diagrammCode .='<tr><td>&nbsp;</td></tr>';
				...
				$diagrammCode .='<tr><td>&nbsp;</td></tr>';
				$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagram9.php?park_no=43&phase=INV1G6&defaults=0,1,2,3,4&args=0,1,0,8379,Inv_AC_PR_600_PR,Inverter1%20PR,15,%,4;0,1,0,8379,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,8379,Inv_AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-6" border="0"></iframe></td></tr>';
				$diagrammCode .='<tr><td>&nbsp;</td></tr>';
				$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagram9.php?park_no=43&phase=INV1G7&defaults=0,1,2,3,4&args=0,1,0,8379,Inv_DC_Vol_Coeff,Inv 1(DC_Voltage),15,V,4;0,1,0,8379,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,8379,Inv_AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-7" border="0"></iframe></td></tr>';
				$count = 7;
			}	
...
/*			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			...
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramLap.php?park_no=55&phase=LAPINV1ACPR&defaults=0,1,2,3,4&args=0,1,0,12669,Inv_AC_PR_600,Inv1%20AC%20PR,15,%,4;0,1,0,12669,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12669,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-6" border="0"></iframe></td></tr>';
			
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramLap.php?park_no=55&phase=LAPINV1DCPR&defaults=0,1,2,3,4&args=0,1,0,12669,DC_Vol_Coeff,Inv1(DC_Voltage),15,V,4;0,1,0,12669,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12669,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-7" border="0"></iframe></td></tr>';
	...
	if($subpark_id==368){ // Energy Meter
	 if ($phase=="tag"){
		...
		$count = 1;
			...
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .= '<tr><td align="left" valign="top"><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramdual.php?park_no=52&phase=DOMINV1graph2&args=0,1,0,11624,A.Ms.Vol-B.Ms.Vol,DC%20Voltage,15,V,8;0,1,0,11624,A.Ms.Amp-B.Ms.Amp,DC%20Current,15,A,7&&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph- 2" border="0"></iframe></td></tr>';
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
		 ...
		 if ($phase=="tag"){
		  ...
		  if ($phase=="tag"){
			...
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .= '<tr><td align="left" valign="top"><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramdual.php?park_no=53&phase=RYINV1G2&args=0,1,0,11721,A.Ms.Vol-B.Ms.Vol,DC%20Voltage,15,V,8;0,1,0,11721,A.Ms.Amp-B.Ms.Amp,DC%20Current,15,A,7&&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph- 2" border="0"></iframe></td></tr>';
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			...
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=53&phase=INV1PR&defaults=0,1,2,3,4&args=0,1,0,11721,Inv_PR,Inv%20PR,15,%,4;0,1,0,11721,Inv_irrad_250,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11721,AC_Module_Temp_250,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-4" border="0"></iframe></td></tr>';
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
		  ...
		  if ($phase=="tag"){
			...
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=53&phase=energyg2&defaults=0,1,2,3&args=0,1,0,10071,System_PR,System PR,15,%,1;0,1,0,11722,En_irradiation,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11722,Energy_Module_Temp,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-2" border="0"></iframe></td></tr>';
			$count = 2;
		...
		if ($subpark_id==376){ // Blk 2
			...
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .= '<tr><td align="left" valign="top"><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramdual.php?park_no=57&phase=ORGINV1graph2&args=0,1,0,12028,A.Ms.Vol-B.Ms.Vol,DC%20Voltage,15,V,8;0,1,0,12028,A.Ms.Amp-B.Ms.Amp,DC%20Current,15,A,7&&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph- 2" border="0"></iframe></td></tr>';
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
...
if($subpark_id==425){ // Block A
		if ($phase=="tag"){
			...
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=59&phase=YamahaEnBlkA&defaults=0,1,2,3&args=0,1,0,12895,System_PR,System PR,15,%,1;0,1,0,12903,En_irradiation,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12903,Energy_Module_Temp,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-2" border="0"></iframe></td></tr>';
			$count = 2;
	...
	if($subpark_id==426){ // Block B
		if ($phase=="tag"){
			...
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=59&phase=YamahaEnBlkB&defaults=0,1,2,3&args=0,1,0,12899,System_PR,System PR,15,%,1;0,1,0,12903,En_irradiation,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12903,Energy_Module_Temp,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-2" border="0"></iframe></td></tr>';
			$count = 2;
	...
	if($subpark_id==428){ // Block D
		if ($phase=="tag"){
			...
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=59&phase=YamahaEnBlkD&defaults=0,1,2,3&args=0,1,0,12898,System_PR,System PR,15,%,1;0,1,0,12900,En_irradiation,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12900,Energy_Module_Temp,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-2" border="0"></iframe></td></tr>';
			$count = 2;
	...
	if($subpark_id==429){ // Block E
		if ($phase=="tag"){
			...
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=59&phase=YamahaEnBlkE&defaults=0,1,2,3&args=0,1,0,12896,System_PR,System PR,15,%,1;0,1,0,12900,En_irradiation,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12900,Energy_Module_Temp,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-2" border="0"></iframe></td></tr>';
			$count = 2;
