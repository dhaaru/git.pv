	 ...
	 if ($phase=="tag"){
		...
		$count = 1;
		 ...
		 if ($phase=="tag"){
				...
				$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=52&phase=energyg2&defaults=0,1,2,3&args=0,1,0,10070,System_PR,System PR,15,%,1;0,1,0,11623,En_irradiation,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,Energy_Module_Temp,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-2" border="0"></iframe></td></tr>';
				$count = 2;
				...
				$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagram5.php?park_no=52&phase=domweather&defaults=0,1,2&args=0,1,0,11623,Solar_Radiation,Irradiation,15,W/m²,\'Gold\';0,1,0,11623,Ambient_Temperature,Ambient Temperature,15,°C,\'darkred\';0,1,0,11623,Module_Temperature,Module_Temperature,15,°C,\'green\';0,1,0,11623,Wind_Speed_Act,Wind Speed,15,m/s,6;&diffs=0,1,0,10070,Forward_Active_Energy,null,8,Yield (EM),black,2, kWh,10,0,Arial;&sums=0,1,0,11623,Solar_Radiation,null,5,Total%20Irradiation,brown,2,%20Wh/m²,10,0,Arial&avgs=0,1,0,11623,Ambient_Temperature,null,9,Avg.%20Ambient%20Temperature,red,2,%20°C,10,0,Arial&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Weather Station" border="0"></iframe></td></tr><br>';
				$count = 1;
		}
		...
		if ($subpark_id==376){ // Blk 2
			...
			$diagrammCode .= '<tr><td align="left" valign="top"><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramPoly.php?park_no=58&phase=PolyINV1EFF&args=0,1,0,12660,Inv1_Eff,Inverter1,15,%,8;&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph- 5" border="0"></iframe></td></tr>';
			
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramPoly.php?park_no=58&phase=PolyINV1ACPR&defaults=0,1,2,3,4&args=0,1,0,12660,Inv_AC_PR,Inv1%20AC%20PR,15,%,4;0,1,0,12417,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12417,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-6" border="0"></iframe></td></tr>';
