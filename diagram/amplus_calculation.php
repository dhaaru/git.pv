...
//$startTime = mktime(0, 0, 0, 02, 02,$crtyr);
//$endTime = mktime(0, 0, 0, 02, 03, $crtyr);
...
$inverterACData1 =getdeviceData($startTime,$endTime,7791,'AC_Power');
$inverterDCData1 =getdeviceData($startTime,$endTime,7791,'DC_Power');


$inverterACData2 =getdeviceData($startTime,$endTime,7792,'AC_Power');
$inverterDCData2 =getdeviceData($startTime,$endTime,7792,'DC_Power');

$inverterACData3 =getdeviceData($startTime,$endTime,7794,'AC_Power');
$inverterDCData3 =getdeviceData($startTime,$endTime,7794,'DC_Power');


//print_r($inverterACData);print_r($inverterDCData);
...
//Energy meter system PR
	echo "select ts, ROUND((value),3) as groupval FROM _devicedatavalue where ts > $startTime and ts < $endTime and  (device='7794') and (field='Solar_Radiation') and value > 250";
