...
# ------------------------------------------------
print ("<p><sub>argdiagramdom influx clean version  'amplus_all_calculations' </sub></p>");
#################################################
...
if(($phase == 'INV1ACPR' && $park_no == 52) || ($phase == 'INV2ACPR' && $park_no == 52) || ($phase == 'INV3ACPR' && $park_no == 52)
	|| ($phase == 'INV4ACPR' && $park_no == 52) || ($phase == 'INV5ACPR' && $park_no == 52)	)
	{ 
		$Module_temp_600=getdeviceData($startTime,$endTime,11624,'AC_Module_Temp_600');

		foreach($Module_temp_600 as $moduleindex1=>$modulevalue){
		$ts= $moduleindex1;
		$mod_value = $modulevalue;
		$qry_inverter1 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=52 AND ts=$ts and (device='11624') and (field='Inv_AC_PR_600')");
		...
		$qry_inverter2 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=52 AND ts=$ts and (device='11627') and (field='Inv_AC_PR_600')");
		...
		$qry_inverter3 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=52 AND ts=$ts and (device='11625') and (field='Inv_AC_PR_600')");
		...
		$qry_inverter4 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=52 AND ts=$ts and (device='11626') and (field='Inv_AC_PR_600')");
		...
		$qry_inverter5 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=52 AND ts=$ts and (device='11628') and (field='Inv_AC_PR_600')");
	...
	if(($phase == 'INV1DCPR' && $park_no == 52) || ($phase == 'INV2DCPR' && $park_no == 52) || ($phase == 'INV3DCPR' && $park_no == 52)
|| ($phase == 'INV4DCPR' && $park_no == 52)	|| ($phase == 'INV5DCPR' && $park_no == 52))
	{
		...
		$ts= $moduleindex1;
		$mod_value = $modulevalue;
		$qry_inverterdc1 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=52 AND ts=$ts and (device='11624') and (field='Inv_DC_Vol_Coeff')");
		...
		$qry_inverterdc2 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=52 AND ts=$ts and (device='11627') and (field='Inv_DC_Vol_Coeff')");
		...
		$qry_inverterdc3 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=52 AND ts=$ts and (device='11625') and (field='Inv_DC_Vol_Coeff')");
		...
		$qry_inverterdc4 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=52 AND ts=$ts and (device='11626') and (field='Inv_DC_Vol_Coeff')");
		...
		$qry_inverterdc5 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=52 AND ts=$ts and (device='11628') and (field='Inv_DC_Vol_Coeff')");
	...
	if(($phase == 'INV1EFF' && $park_no == 52) || ($phase == 'INV2EFF' && $park_no == 52) || ($phase == 'INV3EFF' && $park_no == 52) ||
 ($phase == 'INV4EFF' && $park_no == 52) || ($phase == 'INV5EFF' && $park_no == 52))
	{

		$inver1Eff =getdeviceData($startTime,$endTime,11624,'Inv_Eff');
		$inver2Eff =getdeviceData($startTime,$endTime,11627,'Inv_Eff');
		$inver3Eff =getdeviceData($startTime,$endTime,11625,'Inv_Eff');
		$inver4Eff =getdeviceData($startTime,$endTime,11626,'Inv_Eff');
		$inver5Eff =getdeviceData($startTime,$endTime,11628,'Inv_Eff');
    ...
    $inverEff1 = combineIrradWithInverterEff($inver1Eff,11623,'Solar_Radiation');
  }
  if ($inver2Eff) {
    $inver2Eff = alignTimestamps($inver2Eff);
    $inverEff2 = combineIrradWithInverterEff($inver2Eff,11623,'Solar_Radiation');

  }
  if ($inver3Eff) {
    $inver3Eff = alignTimestamps($inver3Eff);
    $inverEff3 = combineIrradWithInverterEff($inver3Eff,11623,'Solar_Radiation'); 
  }
  if ($inver4Eff) {
    $inver4Eff = alignTimestamps($inver4Eff);
    $inverEff4 = combineIrradWithInverterEff($inver4Eff,11623,'Solar_Radiation');

  }
  if ($inver5Eff) {
    $inver5Eff = alignTimestamps($inver5Eff);
    $inverEff5 = combineIrradWithInverterEff($inver5Eff,11623,'Solar_Radiation'); 
  }
                   ...
                   <!-- <input title="Reset the zoom"    style="flow: left;" id="resetZoom" onClick="resetZoom()" type="image"    src="../imgs/lupe_grey.png" disabled>-->
                    ...
                    if ($exception != 25) {
                        if ($anyArgs) {
							...
							if($phase == "INV1EFF" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11624,Inv1_Eff,Inverter1,15,%,8;0,1,0,11623,Solar_Radiation,Irradiation,5,W/m&sup2;,\'Gold\';">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							
							if($phase == "INV2EFF" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11627,Inv2_Eff,Inverter2,15,%,8;0,1,0,11623,Solar_Radiation,Irradiation,5,W/m&sup2;,\'Gold\';">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "INV3EFF" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11625,Inv3_Eff,Inverter3,15,%,8;0,1,0,11623,Solar_Radiation,Irradiation,5,W/m&sup2;,\'Gold\';">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "INV4EFF" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11626,Inv4_Eff,Inverter4,15,%,8;0,1,0,11623,Solar_Radiation,Irradiation,5,W/m&sup2;,\'Gold\';">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "INV5EFF" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11628,Inv5_Eff,Inverter5,15,%,8;0,1,0,11623,Solar_Radiation,Irradiation,5,W/m&sup2;,\'Gold\';">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}							
							
							 if($phase == "INV1ACPR" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11624,Inv_AC_PR,Inv1%20AC%20PR,15,%,4;0,1,0,11623,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}  
							if($phase == "INV2ACPR" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11627,Inv_AC_PR,Inv2%20AC%20PR,15,%,4;0,1,0,11623,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							} 
							if($phase == "INV3ACPR" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11625,Inv_AC_PR,Inv3%20AC%20PR,15,%,4;0,1,0,11623,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							} 
							if($phase == "INV4ACPR" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11626,Inv_AC_PR,Inv4%20AC%20PR,15,%,4;0,1,0,11623,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							} 
							if($phase == "INV5ACPR" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11628,Inv_AC_PR,Inv5%20AC%20PR,15,%,4;0,1,0,11623,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							} 
							if($phase == "INV1DCPR" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11624,DC_Vol_Coeff,Inv 1(DC_Voltage),15,V,4;0,1,0,11623,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "INV2DCPR" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11627,DC_Vol_Coeff,Inv 2(DC_Voltage),15,V,4;0,1,0,11623,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "INV3DCPR" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11625,DC_Vol_Coeff,Inv 3(DC_Voltage),15,V,4;0,1,0,11623,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "INV4DCPR" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11626,DC_Vol_Coeff,Inv 4(DC_Voltage),15,V,4;0,1,0,11623,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "INV5DCPR" && $park_no=="52"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11628,DC_Vol_Coeff,Inv 5(DC_Voltage),15,V,4;0,1,0,11623,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,11623,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
                        }
...
<?php if(($phase == 'INV1EFF' && $park_no == 52) || ($phase == 'INV2EFF' && $park_no == 52)|| ($phase == 'INV3EFF' && $park_no == 52) ||
 ($phase == 'INV4EFF' && $park_no == 52) || ($phase == 'INV5EFF' && $park_no == 52)){?>
	
$(function() {

			var datasets = {
						<?php if($phase == 'INV1EFF' && $park_no == 52) {?>
							"Inv1 Efficency": {
								label: "Inv1 Efficency", points: { symbol: "circle" },
								data: <?php echo $inverEff1;   ?>
							}, 
						<?php } else if($phase == 'INV2EFF' && $park_no == 52){?>						
							"Inv2 Efficency": {
								label: "Inv2 Efficency", points: { symbol: "circle" }, 
							data:<?php echo $inverEff2; ?> 
							},
						<?php } else if($phase == 'INV3EFF' && $park_no == 52){?>
							"Inv3 Efficency": {
								label: "Inv3 Efficency", points: { symbol: "circle" },
							data: <?php echo $inverEff3; ?>
							},
						<?php }else if($phase == 'INV4EFF' && $park_no == 52){?>
							"Inv4 Efficency": {
								label: "Inv4 Efficency", points: { symbol: "circle" },
							data: <?php echo $inverEff4; ?>
							},
						<?php }else if($phase == 'INV5EFF' && $park_no == 52){?>
							"Inv5 Efficency": {
