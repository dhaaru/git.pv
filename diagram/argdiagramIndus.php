...
# ------------------------------------------------
print ("<p><sub>argdiagramIndus influx clean version  'amplus_all_calculations' </sub></p>");
#################################################
...
if(($phase == 'IndINV1ACPR' && $park_no == 54) || ($phase == 'IndINV2ACPR' && $park_no == 54) ||($phase == 'IndINV3ACPR' && $park_no == 54))
	{ 
		$Module_temp_600=getdeviceData($startTime,$endTime,13004,'AC_Module_Temp_600');

		foreach($Module_temp_600 as $moduleindex1=>$modulevalue){
		$ts= $moduleindex1;
		$mod_value = $modulevalue;
		$qry_inverter1 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=54 AND ts=$ts and (device='12667') and (field='Inv_AC_PR_600')");
		...
		$qry_inverter2 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=54 AND ts=$ts and (device='12668') and (field='Inv_AC_PR_600')");
		...
		$qry_inverter3 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=54 AND ts=$ts and (device='13004') and (field='Inv_AC_PR_600')");
	...
	if(($phase == 'IndINV1DCPR' && $park_no == 54) || ($phase == 'IndINV2DCPR' && $park_no == 54) || ($phase == 'IndINV3DCPR' && $park_no == 54))
	{
		...
		$ts= $moduleindex1;
		$mod_value = $modulevalue;
		$qry_inverterdc1 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=54 AND ts=$ts and (device='12667') and (field='Inv_DC_Vol_Coeff')");
		...
		$qry_inverterdc2 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=54 AND ts=$ts and (device='12668') and (field='Inv_DC_Vol_Coeff')");
		...
		$qry_inverterdc3 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=54 AND ts=$ts and (device='13004') and (field='Inv_DC_Vol_Coeff')");
	...
	if(($phase == 'IndINV1EFF' && $park_no == 54) || ($phase == 'IndINV2EFF' && $park_no == 54) || ($phase == 'IndINV3EFF' && $park_no == 54))
	{
		$inver1Eff =getdeviceData($startTime,$endTime,12667,'Inv_Eff');
		$inver2Eff =getdeviceData($startTime,$endTime,12668,'Inv_Eff');
		$inver3Eff =getdeviceData($startTime,$endTime,13004,'Inv_Eff');
    ...
    $inverEff1 = combineIrradWithInverterEff($inver1Eff,10452,'Solar_Radiation');
  }
  if ($inver2Eff) {
    $inver2Eff = alignTimestamps($inver2Eff);
    $inverEff2 = combineIrradWithInverterEff($inver2Eff,10452,'Solar_Radiation');

  }
  if ($inver3Eff) {
    $inver3Eff = alignTimestamps($inver3Eff);
    $inverEff3 = combineIrradWithInverterEff($inver3Eff,10452,'Solar_Radiation'); 
  }
...
<?php if(($phase == 'IndINV1EFF' && $park_no == 54) || ($phase == 'IndINV2EFF' && $park_no == 54) || ($phase == 'IndINV3EFF' && $park_no == 54)){?>
	$(function() {

			var datasets = {
			"Inv Efficency": {
				
				<?php if($phase == 'IndINV1EFF'){?>
				label: "Inv1 Efficency", points: { symbol: "circle" },
				data: <?php echo $inverEff1; ?>
				<?php } else if($phase == 'IndINV2EFF'){?>
				label: "Inv2 Efficency", points: { symbol: "circle" },
				data: <?php echo $inverEff2; ?>
				<?php } else if($phase == 'IndINV3EFF'){?>
	...
	<?php }elseif(($phase == 'IndINV1ACPR' && $park_no == 54) || ($phase == 'IndINV2ACPR' && $park_no == 54) || ($phase == 'IndINV3ACPR' && $park_no == 54)){?>
	$(function() {

		var data = [
			<?php if($phase == 'IndINV1ACPR'){?>
			{ data: <?php echo $invACPR1; ?>, points: { symbol: "diamond" }, label: "INV1 AC PR (%)" }
			<?php } else if($phase == 'IndINV2ACPR'){?>
			{ data: <?php echo $invACPR2; ?>, points: { symbol: "diamond" }, label: "INV2 AC PR (%)" }
			<?php } else if($phase == 'IndINV3ACPR'){?>
	...
	<?php }elseif(($phase == 'IndINV1DCPR' && $park_no == 54) || ($phase == 'IndINV2DCPR' && $park_no == 54) || ($phase == 'IndINV3DCPR' && $park_no == 54)){?>
	$(function() {

		var data = [
			<?php if($phase == 'IndINV1DCPR'){?>
			{ data: <?php echo $inverDCPR1; ?>, points: { symbol: "circle" }, label: "INV1 DC Voltage(V)" }
			<?php } else if($phase == 'IndINV2DCPR'){?>
			{ data: <?php echo $inverDCPR2; ?>, points: { symbol: "circle" }, label: "INV2 DC Voltage(V)" }
			<?php } else if($phase == 'IndINV3DCPR'){?>
