...
if ($portal == "20") {
	...
	$header1= "Timestamp, Temperature, Irradiation 1, Irradiation 2, Wind speed, Wind direction, Energy total";
	$header2= "DD/MM/YYYY HH:MM, °C, W/sq.m, W/sq.m, m/s, degree, kwh";
	for ($wrCounter = 0; $wrCounter < $wrIndex; $wrCounter++) {
		$header1.= $wrs[$wrCounter][0]);
		$header2.= "kWh";
	}
