...
$endstamp = $endstamp;
        ...
        <iframe id="framea" width="99%" height="99%" SRC="argdiagram5.php?<?php echo $argsSplit[$selectedOption]."&diffs=".$diffs."&sums=".$sums."&avgs=".$avgs."&hideClear=".$hideClear."&stamp=".$stamp."&endstamp=".$endstamp?>'" border="0"></iframe>
