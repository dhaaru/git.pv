...
# ------------------------------------------------
print ("<p><sub>argdiagramRud influx clean version  'amplus_all_calculations' </sub></p>");
#################################################
...
if(($phase == 'RUDINV1ACPR' && $park_no == 56) || ($phase == 'RUDINV2ACPR' && $park_no == 56) || ($phase == 'RUDINV3ACPR' && $park_no == 56)
	|| ($phase == 'RUDINV4ACPR' && $park_no == 56) || ($phase == 'RUDINV5ACPR' && $park_no == 56)	)
	{ 
		$Module_temp_600=getdeviceData($startTime,$endTime,11621,'AC_Module_Temp_600');

		foreach($Module_temp_600 as $moduleindex1=>$modulevalue){

		$ts= $moduleindex1;
		$mod_value = $modulevalue;
		$qry_inverter1 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=56 AND ts=$ts and (device='11621') and (field='Inv_AC_PR_600')");
		...
		$qry_inverter2 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=56 AND ts=$ts and (device='11618') and (field='Inv_AC_PR_600')");
		...
		$qry_inverter3 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=56 AND ts=$ts and (device='11617') and (field='Inv_AC_PR_600')");
		...
		$qry_inverter4 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=56 AND ts=$ts and (device='11620') and (field='Inv_AC_PR_600')");
		...
		$qry_inverter5 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=56 AND ts=$ts and (device='11619') and (field='Inv_AC_PR_600')");
	...
	if(($phase == 'RUDINV1DCPR' && $park_no == 56) || ($phase == 'RUDINV2DCPR' && $park_no == 56) || ($phase == 'RUDINV3DCPR' && $park_no == 56)
|| ($phase == 'RUDINV4DCPR' && $park_no == 56)	|| ($phase == 'RUDINV5DCPR' && $park_no == 56))
	{
		...
		$ts= $moduleindex1;
		$mod_value = $modulevalue;
		$qry_inverterdc1 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=56 AND ts=$ts and (device='11621') and (field='Inv_DC_Vol_Coeff')");
		...
		$qry_inverterdc2 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=56 AND ts=$ts and (device='11618') and (field='Inv_DC_Vol_Coeff')");
		...
		$qry_inverterdc3 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=56 AND ts=$ts and (device='11617') and (field='Inv_DC_Vol_Coeff')");
		...
		$qry_inverterdc4 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=56 AND ts=$ts and (device='11620') and (field='Inv_DC_Vol_Coeff')");
		...
		$qry_inverterdc5 = mysql_query("SELECT  ROUND((value),3) as groupval,ts FROM amplus_all_calculations WHERE park_no=56 AND ts=$ts and (device='11619') and (field='Inv_DC_Vol_Coeff')");
	...
	if(($phase == 'RUDINV1EFF' && $park_no == 56) || ($phase == 'RUDINV2EFF' && $park_no == 56) || ($phase == 'RUDINV3EFF' && $park_no == 56) ||
 ($phase == 'RUDINV4EFF' && $park_no == 56) || ($phase == 'RUDINV5EFF' && $park_no == 56))
	{
		$inver1Eff =getdeviceData($startTime,$endTime,11621,'Inv_Eff');
		$inver2Eff =getdeviceData($startTime,$endTime,11618,'Inv_Eff');
		$inver3Eff =getdeviceData($startTime,$endTime,11617,'Inv_Eff');
		$inver4Eff =getdeviceData($startTime,$endTime,11620,'Inv_Eff');
		$inver5Eff =getdeviceData($startTime,$endTime,11619,'Inv_Eff');
    ...
    $inverEff1 = combineIrradWithInverterEff($inver1Eff,12690,'Solar_Radiation');
  }
  if ($inver2Eff) {
    $inver2Eff = alignTimestamps($inver2Eff);
    $inverEff2 = combineIrradWithInverterEff($inver2Eff,12690,'Solar_Radiation');

  }
  if ($inver3Eff) {
    $inver3Eff = alignTimestamps($inver3Eff);
    $inverEff3 = combineIrradWithInverterEff($inver3Eff,12690,'Solar_Radiation'); 
  }
  if ($inver4Eff) {
    $inver4Eff = alignTimestamps($inver4Eff);
    $inverEff4 = combineIrradWithInverterEff($inver4Eff,12690,'Solar_Radiation');

  }
  if ($inver5Eff) {
    $inver5Eff = alignTimestamps($inver5Eff);
    $inverEff5 = combineIrradWithInverterEff($inver5Eff,12690,'Solar_Radiation'); 
  }
                   ...
                   <!-- <input title="Reset the zoom"    style="flow: left;" id="resetZoom" onClick="resetZoom()" type="image"    src="../imgs/lupe_grey.png" disabled>-->
                    ...
                    if ($exception != 25) {
                        if ($anyArgs) {
							...
							if($phase == "RUDINV1EFF" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11621,Inv_Eff,Inverter1,15,%,8;0,1,0,12690,Solar_Radiation,Irradiation,5,W/m&sup2;,\'Gold\';">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							
							if($phase == "RUDINV2EFF" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11618,Inv_Eff,Inverter2,15,%,8;0,1,0,12690,Solar_Radiation,Irradiation,5,W/m&sup2;,\'Gold\';">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "RUDINV3EFF" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11617,Inv_Eff,Inverter3,15,%,8;0,1,0,12690,Solar_Radiation,Irradiation,5,W/m&sup2;,\'Gold\';">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "RUDINV4EFF" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11620,Inv_Eff,Inverter4,15,%,8;0,1,0,12690,Solar_Radiation,Irradiation,5,W/m&sup2;,\'Gold\';">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "RUDINV5EFF" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11619,Inv_Eff,Inverter5,15,%,8;0,1,0,12690,Solar_Radiation,Irradiation,5,W/m&sup2;,\'Gold\';">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}							
							
							 if($phase == "RUDINV1ACPR" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11621,Inv_AC_PR,Inv1%20AC%20PR,15,%,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}  
							if($phase == "RUDINV2ACPR" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11618,Inv_AC_PR,Inv2%20AC%20PR,15,%,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							} 
							if($phase == "RUDINV3ACPR" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11617,Inv_AC_PR,Inv3%20AC%20PR,15,%,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							} 
							if($phase == "RUDINV4ACPR" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11620,Inv_AC_PR,Inv4%20AC%20PR,15,%,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							} 
							if($phase == "RUDINV5ACPR" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11619,Inv_AC_PR,Inv5%20AC%20PR,15,%,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							} 
							if($phase == "RUDINV1DCPR" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11621,DC_Vol_Coeff,Inv 1(DC_Voltage),15,V,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "RUDINV2DCPR" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11618,DC_Vol_Coeff,Inv 2(DC_Voltage),15,V,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "RUDINV3DCPR" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11617,DC_Vol_Coeff,Inv 3(DC_Voltage),15,V,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "RUDINV4DCPR" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11620,DC_Vol_Coeff,Inv 4(DC_Voltage),15,V,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
							if($phase == "RUDINV5DCPR" && $park_no=="56"){
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&phase=' . $phase .'&args=0,1,0,11619,DC_Vol_Coeff,Inv 5(DC_Voltage),15,V,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
                        }
...
<?php if(($phase == 'RUDINV1EFF' && $park_no == 56) || ($phase == 'RUDINV2EFF' && $park_no == 56)|| ($phase == 'RUDINV3EFF' && $park_no == 56) ||
 ($phase == 'RUDINV4EFF' && $park_no == 56) || ($phase == 'RUDINV5EFF' && $park_no == 56)){?>
	$(function() {
