...
<html>
    <head>
        ...
        <script>  
            function OnLoad(){
                if(parent.navigation.location != '../navigation.php?park_no=<?php echo $park_no; ?>&subpark=<?php echo $subpark_id; ?>&meter_existent=<?php echo $meter_existent; ?>')  parent.navigation.location.href='../navigation.php?park_no=<?php echo $park_no; ?>&subpark=<?php echo $subpark_id; ?>&meter_existent=<?php echo $meter_existent; ?>';
...
foreach ($links as $link) {
    ...
    $query = "select * from _link where id = $link[2]";
    ...
    echo 'drawLink(' . $link[0] . ',' . $link[1] . ',"' . $row_ds2[url] . '","' . $link[3] . '",' . $link[4] .');';
    mysql_free_result($ds2);
}
?>
