...
$iverterDCData = array();
$device =array('8379','8408','8410','8409','8458','8456','8381','12976','8378','8384','8382','8383','8380','8386','8387','8388'); 
$device_ref =array('8379','8381','8378','8380'); //4 refusol inverter
$device_sma =array('8410','8409','8458','8456','12976','8384','8382','8383','8408','8386','8387','8388'); //12 SMA
...
elseif($device == 12976){$n=8; $sensor=8414; $mod=7; $voc=85.6;}
		...
		foreach ($inverterDCData as $inverterDCPowerData ){
			foreach($inverterACPowerData as $acindex1=>$acpower1){
				...
				if($acindex1 == $dcindex1)
					...
					elseif($device == 12976){$n=8; $sensor=8414; $totMod=111; $eff=0.201; $area=2.067*1.046;}
...
$qry3="select  ROUND((value),3) as groupval,ts FROM _devicedatavalue where ts BETWEEN $stime AND $etime and (device=$sensor) and (field='Solar_Radiation') and value > 600";
	...
	$inverterACData8 =getdeviceData2($startTime,$endTime,12976,'Pac','');
	$inverterDCData8 =getdeviceData2($startTime,$endTime,12976,'Upv-Ist','Ipv');
